...
function mobileCopyJsControllers() {
...
exports.mobileMinifyJs = gulp.series(delDist, mobileMinifyCss, mobileCopyJsControllers, mobileMinifyJs);
...
function mobileRev() {
    return gulp.src(paths.distMobile.all)
        //.pipe(sourcemaps.init())
        .pipe(revAll.revision({ dontSearchFile: ['.js', '.css'] }))
        //.pipe(sourcemaps.write('.'))
...
function mobileCopyImg() {
    return gulp.src(paths.baseStatic + paths.sourceMobile.img)
        .pipe(gulp.dest(paths.baseStatic + paths.distMobile.imgDir))
}


exports.mobileProduction = gulp.series(delDist, mobileMinifyCss, mobileCopyJsControllers, mobileMinifyJs, mobileRev, mobileCopyImg);
