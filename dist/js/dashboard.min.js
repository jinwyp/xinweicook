angular.module("RDash",["ui.bootstrap","ui.router","ngCookies"]),angular.module("RDash.config",["ngStorage","ui-router"]),angular.module("RDash.models",["ngStorage"]);
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider","$httpProvider",function(e,t,o){t.otherwise(function(e,t){return e.get("$localStorage").access_token?"/":"/login"}),o.defaults.headers.common.Accept="application/vnd.cook.v1+json",o.defaults.headers.common["Accept-Language"]="application/vnd.cook.v1+json",o.interceptors.push("commonInterceptor"),e.state("index",{url:"/",templateUrl:"templates/dashboard.html"}).state("index.tables",{url:"^/tables",templateUrl:"templates/tables.html"}).state("login",{url:"/login",templateUrl:"templates/login.html"})}]),angular.module("RDash.config").factory("commonInterceptor",["$localStorage","$q","$state",function(e,t,o){return{request:function(t){return e.access_token&&(t.headers.Authorization="Bearer "+e.access_token),t},responseError:function(e){return 403==e.status&&o.go("login"),t.reject(e)}}}]);
...
angular.module("RDash.models").factory("User",function(a,e){return{login:function(n,t){return a.post("/api/user/token",{username:n,password:t,grant_type:"password"}).then(function(a){return a.data&&a.data.access_token&&(e.access_token=a.data.access_token),a})}}});