...
exports.orderList = function(req, res, next) {
    ...
    models.order.find({}).sort("-createdAt").limit (5000).populate({path: 'dishList.dish', select: models.dish.fields()}).populate({path: 'dishList.subDish.dish', select: models.dish.fields()}).execAsync().then(function(resultOrderList){
