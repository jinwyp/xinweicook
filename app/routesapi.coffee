...
#  app.use libs.secure.middleware
  ...
  app.post("/api/user/address/suggestion", userController.getPlaceSuggestion)
  ...
  app.post("/api/orders/payment/alipay/sign", libs.auth("member"), orderController.generateAlipaySign)
  ...
  app.get("/api/orders/delivery/range", deliveryController.deliveryAddressForCook)
...
#  app.post("/api/administrator/coupons/user", couponController.assignCouponToUser)
  ...
  app.get("/api/admin/statistic/order/monthly", orderStatController.orderMonthlySales)
  app.get("/api/admin/statistic/order/weekly", orderStatController.orderWeeklySales)
  ...
  app.get("/api/admin/statistic/user/firstorder/daily", userStatController.userGetFirstEatOrderDaily)
  app.get("/api/admin/statistic/user/firstorder/monthly", userStatController.userGetFirstEatOrderMonthly)
  app.get("/api/admin/statistic/user/order/frequency", userStatController.userOrderFrequency)
  app.get("/api/admin/statistic/user/order/more4", userStatController.userListAbove4Orders)
  app.get("/api/admin/statistic/user/account", userStatController.userListBak)
