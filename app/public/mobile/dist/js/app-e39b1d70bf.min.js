...
angular.module("xw.directives").directive("address",["$timeout","$location","Address","Utils","$q","Weixin","Map",function(e,t,r,d,s,n,o){return{restrict:"E",scope:{outAddress:"=",range:"=",save:"=",leave:"=",valid:"=",deleteHook:"&",hide:"&",cur:"@"},templateUrl:"address.html",link:function(e){var i,a=e.css={edit:!1,cur:"true"==e.cur,showSearchAddress:!1,form:null,locating:!1,isWeixin:n.isWeixin,isNewAddress:Object.keys(e.outAddress).length<2},u=e.data={street:""};a.isNewAddress?(i=e.addr={sortOrder:0},a.cur&&(a.edit=!0)):i=e.addr=d.regularizeAddress(angular.copy(e.outAddress),e.range),e.outAddress.cur=a.cur,e.outAddress.edit=!!a.edit,e.options=d.addressOptions.bind(null,e.range),e.$on("$locationChangeStart",function(){if(a.edit){var e=t.path();a.showSearchAddress="/search-address"==e}}),e.choose=function(){a.cur?(a.edit=!0,e.outAddress.edit=!0):(a.cur=!0,a.isNewAddress&&(a.edit=!0,e.outAddress.edit=!0)),e.outAddress.cur=!0},e.trySelectUnique=function(){var t=e.options(i.province);1==t.length&&(i.city=t[0])},e.deleteAddress=function(t){t.stopPropagation(),r["delete"](i._id),e.deleteHook&&e.deleteHook()},e.showSearchAddress=function(){u.street=i.street,t.path("search-address"),e.data.streetList&&(e.data.streetList.length=0),e.searchAddress()},e.searchAddress=function(){u.street&&o.search(u.street,i.city||"全国").then(function(t){e.data.streetList=t.data.results})},e.confirmStreet=function(e,r){e.stopPropagation(),t.path(""),r&&(i.street=r.name,i.geoLatitude=r.location.lat,i.geoLongitude=r.location.lng)},e.save=function(){return a.form.$invalid?s.resolve(!1):(a.edit=a.cur=!1,e.outAddress.edit=e.outAddress.cur=!1,r[a.isNewAddress?"addOne":"update"](i).then(function(t){return i=e.addr=t.data,angular.extend(e.outAddress,t.data),t.data}))},e.leave=function(){e.outAddress.cur=a.cur=!1},e.valid=function(){return a.form.$submitted=!0,!a.form.$invalid},e.initForm=function(e){a.form=e,a.showFakeInput=!i.province},e.locate=function(t){t.stopPropagation(),a.locating=!0,n.getLocation(function(t){n.getLocationName(t.latitude,t.longitude).then(function(r){var s=r.data.result;s=angular.pick(s.addressComponent,"province","city","district","street","street_number");var n=o.gcj02ToBd09({lat:t.latitude,lng:t.longitude});s.geoLatitude=n.lat,s.geoLongitude=n.lng,d.regularizeAddress(s,e.range),angular.extend(i,s)})["catch"](angular.noop).then(function(){a.locating=!1})},function(){a.locating=!1})}}}}]);
angular.module("xw.directives").directive("addressList",["$q",function(e){return{restrict:"E",scope:{addresses:"=",range:"=",watchAddress:"=save",editing:"=",hideOthersWhenEdit:"@"},templateUrl:"address-list.html",link:function(s){var d=s.data={newAddress:{}},r=s.handler={save:[],leave:[],valid:[]};s.editing=function(){return s.addresses?!!d.newAddress.edit||s.addresses.some(function(e){return e.edit}):!1},s.remove=function(e){s.addresses.splice(e,1),r.save.splice(e,1),r.leave.splice(e,1),r.valid.splice(e,1)},s.watchAddress=function(n){var a,t=n.target,i=t;do if(-1!=i.className.indexOf("address-item"))for(var l=i.parentElement.children,c=0,o=l.length;o>c;c++)if(l[c]==i){a=c;break}while(i=i.parentElement);var v=-1,u=-1;if(s.addresses.forEach(function(e,s){e.edit&&(v=s),e.cur&&(u=s)}),!(a==u||a==s.addresses.length&&d.newAddress.cur)){var f;if(-1!=v){if(!r.valid[v]())return n.stopPropagation();f=r.save[v]()}else if(d.newAddress.edit){if(!r.valid.newAddress())return n.stopPropagation();f=r.save.newAddress().then(function(e){return s.addresses.push(e),d.newAddress={},e})}return-1!=u?(r.leave[u](),-1==v&&(f=e.resolve(s.addresses[u]))):d.newAddress.cur&&r.leave.newAddress(),f}}}}}]);
...
angular.module("xw.directives").directive("menuNav",function(){return{restrict:"E",scope:{path:"@",localBag:"=",isAddressOk:"&"},templateUrl:"menu-nav.html",link:function(e){e.goToCart=function(){location.href="/mobile/cart"}}}});
