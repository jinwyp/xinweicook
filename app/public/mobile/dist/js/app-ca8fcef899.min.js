...
angular.module("xw.filters").filter("adapt",function(){var e=Math.floor(document.body.offsetWidth*window.devicePixelRatio),n=Math.floor(2*e/3),r="?imageView2/1/w/",t=r+e+"/h/"+n;return function(n,i){return n+(i?r+e+"/h/"+Math.floor(e*i):t)}}),angular.module("xw.filters").filter("fraction",function(){function e(e,n){for(var r="",t=0;t<e.length;t++)r+=n[e[t]];return r}var n=["⁰","¹","²","³","⁴","⁵","⁶","⁷","⁸","⁹"],r=["₀","₁","₂","₃","₄","₅","₆","₇","₈","₉"];return function(t){return t.replace(/(\d+)\/(\d+)/g,function(t,i,u){return e(i,n)+"⁄"+e(u,r)+" "})}}),angular.module("xw.filters").filter("postDish",function(){return function(e){return{dish:e.dish._id,number:e.number,subDish:e.subDish?e.subDish.map(function(e){return{dish:e.dish._id,number:e.number}}):[]}}}),angular.module("xw.filters").filter("beautifyMobile",function(){return function(e){return/^\d{11}$/.test(e)?e.replace(/^(\d{3})(\d{4})(\d{4})$/,function(e,n,r,t){return n+" "+r+" "+t}):e}}),angular.module("xw.filters").filter("subDishTitle",function(){return function(e){var n=e.subDish.length;return n?"("+e.subDish.reduce(function(e,r,t){return e+r.dish.title.zh+(t==n-1?"":"/")},"")+")":""}}),angular.module("xw.filters").filter("orderTime",function(){return function e(n,r){var t;return"eat"==r?{deliveryDateEat:n.hour.substr(0,10),deliveryTimeEat:n.hour.substr(11,5)}:"cook"==r?(t={deliveryDateCook:n.day},t.deliveryTimeCook=n.segment?n.segment.name+":00":"12:00",t):"all"==r?(t={},n.eat&&(t=e(n.eat,"eat")),n.cook&&angular.extend(t,e(n.cook,"cook")),t):void 0}}),angular.module("xw.filters").filter("cookTimeUnion",function(){return function(e,n,r,t){if(!e||!e.length)return e;n&&(e=[{day:"2016-02-06",segment:[{name:"10",text:"10:00-20:00",status:!0}]}]),r&&(e=t?[{day:"2016-02-13",segment:[{name:"10",text:"10:00-20:00",status:!0}]},{day:"2016-02-14",segment:[{name:"10",text:"10:00-20:00",status:!0}]}]:[{day:"2016-02-14",segment:[{name:"10",text:"10:00-20:00",status:!0}]}]);var i=!!e[0].segment;return e.reduce(function(e,n){return i?n.segment.forEach(function(r){e.push({day:n.day,segment:r})}):e.push({day:n.day}),e},[])}}),angular.module("xw.filters").filter("dishes",function(){return function(e,n,r){var t;return"order"==n&&"displayCart"==r?(t=[],Object.keys(e).forEach(function(n){e[n].forEach(function(e){t.push({dish:e.dish._id,number:e.number,subDish:e.subDish.map(function(e){return{dish:e.dish._id,number:e.number}})})})}),{dishList:t}):e}}),angular.module("xw.filters").filter("coupon",function(){return function(e){var n={};return e.code&&(n.promotionCode=e.code,8==e.code.length&&(n.promotionCode="zz"+n.promotionCode)),e.card&&(n.coupon=e.card._id),n}}),angular.module("xw.filters").filter("eatTimeOptions",function(){return function(e){return e&&e.length?(e.unshift({hour:"请选择配送时间"}),e):e}}),angular.module("xw.filters").filter("eatTimeDisplay",function(){return function(e){return e.hour}}),angular.module("xw.filters").filter("cookTimeOptions",function(){return function(e){return e&&e.length?(e.unshift({day:"请选择配送时间"}),e):e}}),angular.module("xw.filters").filter("cookTimeDisplay",function(){return function(e){return"请选择配送时间"==e.day||e.segment?e.day:e.day+" 送达"}}),angular.module("xw.filters").filter("dishPrice",function(){return function(e,n){var r=e.dish.priceOriginal;if(e.subDish)for(var t=0,i=e.subDish.length;i>t;t++)r+=e.subDish[t].dish.priceOriginal;return r*(n?e.number:1)}}),angular.module("xw.filters").filter("orderStatus",function(){var e={"not paid":"未支付",paid:"已支付",confirmed:"已确认","dish finished":"已完成",packaged:"已打包",shipped:"配送中",finished:"已完成",canceled:"已取消"};return function(n){return e[n]||""}}),angular.module("xw.filters").filter("orderId",function(){return function(e){if(!e)return e;for(var n=[],r=0;r<e.length;r+=4)n.push(e.substr(r,4));return n.join(" ")}}),angular.module("xw.filters").filter("payment",function(){var e={"alipay direct":"支付宝",weixinpay:"微信钱包","account balance":"新味币"};return function(n){return e[n]||n}});
...
//# sourceMappingURL=app-ca8fcef899.min.js.map
