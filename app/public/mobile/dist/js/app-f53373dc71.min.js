...
angular.module("xw.directives").directive("addDishBar",["Debug","User","$localStorage","$filter","Utils",function(e,r,t,i,n){return{scope:{dish:"=",user:"=",localBag:"="},templateUrl:"add-dish-bar.html",link:function(e){var o=e.storage=t,u=e.localBag=[],a=e.$watch("user",function(r){r&&(a(),e.localBag=u=n.mergeCarts(u,r.shoppingCart),e.totalPrice())});e.$watch("dish",function(r){if(r){var t={};e.dish.preferences.forEach(function(e){e.foodMaterial.forEach(function(e){e.outOfStock=n.stockOfItem(e,o.warehouse||"")}),e.foodMaterial.some(function(r){return r.outOfStock?!1:(t[e.name.zh]=r.dish,!0)})}),e.dish.curSelection=t}}),e.addToCart=function(t){var i,o=t.curSelection,a={dish:t,number:t.count,subDish:Object.keys(o).map(function(e){return{dish:o[e],number:t.count}})};u.some(function(e){return n.isSameItemInCart(e,a)?(i=e,i.number+=a.number,i.subDish.forEach(function(e){e.number=i.number}),!0):void 0}),i||u.push(a),t.count=0,e.hide(),r.postCart(u.map(c)),e.totalPrice()};var c=i("postDish");e.totalPrice=function(){var e=u.reduce(function r(e,t){return e+=t.dish.priceOriginal*t.number,t.subDish&&(e+=t.subDish.reduce(r,0)),e},0);return u.price=e},e.totalPrice(),e.hide=function(){e.dish=null}}}}]);
...
//# sourceMappingURL=app-f53373dc71.min.js.map
