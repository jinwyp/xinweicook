...
angular.module("xw.directives").directive("addDishBar",["Debug","User","$localStorage","$filter","Utils",function(r,t,e,i,a){return{scope:{dish:"=",user:"=",cart:"="},templateUrl:"add-dish-bar.html",link:function(r){var c=r.$watch("user",function(t){t&&(c(),r.cart=a.mergeCarts(e.localBag||[],t.shoppingCart),r.totalPrice())});r.$watch("dish",function(t){if(t){var e={};r.dish.preferences.forEach(function(r){r.foodMaterial.some(function(t){return t.dish.outOfStock?!1:(e[r.name.zh]=t.dish,!0)})}),r.dish.curSelection=e}}),e.localBag&&(r.cart=e.localBag),r.addToCart=function(i){var c,u=i.curSelection,o={dish:i,number:i.count,subDish:Object.keys(u).map(function(r){return{dish:u[r],number:i.count}})};r.cart.some(function(r){return a.isSameItemInCart(r,o)?(c=r,c.number+=o.number,c.subDish.forEach(function(r){r.number=c.number}),!0):void 0}),c||r.cart.push(o),i.count=0,r.hide(),t.postCart(r.cart.map(n)),r.totalPrice(),e.localBag=r.cart};var n=i("postDish");r.totalPrice=function(){var t=r.cart.reduce(function e(r,t){return r+=t.dish.priceOriginal*t.number,t.subDish&&(r+=t.subDish.reduce(e,0)),r},0);return r.cart.price=t},r.totalPrice(),r.hide=function(){r.dish=null}}}}]);
