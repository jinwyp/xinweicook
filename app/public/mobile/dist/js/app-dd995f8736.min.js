...
angular.module("xw.filters").filter("adapt",function(){var e=Math.floor(document.body.offsetWidth*window.devicePixelRatio),r=Math.floor(2*e/3),n="?imageView2/1/w/",t=n+e+"/h/"+r;return function(r,i){return r+(i?n+e+"/h/"+Math.floor(e*i):t)}}),angular.module("xw.filters").filter("fraction",function(){function e(e,r){for(var n="",t=0;t<e.length;t++)n+=r[e[t]];return n}var r=["⁰","¹","²","³","⁴","⁵","⁶","⁷","⁸","⁹"],n=["₀","₁","₂","₃","₄","₅","₆","₇","₈","₉"];return function(t){return t.replace(/(\d+)\/(\d+)/g,function(t,i,u){return e(i,r)+"⁄"+e(u,n)+" "})}}),angular.module("xw.filters").filter("postDish",function(){return function(e){return{dish:e.dish._id,number:e.number,subDish:e.subDish?e.subDish.map(function(e){return{dish:e.dish._id,number:e.number}}):[]}}}),angular.module("xw.filters").filter("beautifyMobile",function(){return function(e){return/^\d{11}$/.test(e)?e.replace(/^(\d{3})(\d{4})(\d{4})$/,function(e,r,n,t){return r+" "+n+" "+t}):e}}),angular.module("xw.filters").filter("subDishTitle",function(){return function(e){var r=e.subDish.length;return r?"("+e.subDish.reduce(function(e,n,t){return e+n.dish.title.zh+(t==r-1?"":"/")},"")+")":""}}),angular.module("xw.filters").filter("orderTime",function(){return function e(r,n){var t;return"eat"==n?{deliveryDateEat:r.hour.substr(0,10),deliveryTimeEat:r.hour.substr(11,5)}:"cook"==n?(t={deliveryDateCook:r.day},t.deliveryTimeCook=r.segment?r.segment.name+":00":"12:00",t):"all"==n?(t={},r.eat&&(t=e(r.eat,"eat")),r.cook&&angular.extend(t,e(r.cook,"cook")),t):void 0}}),angular.module("xw.filters").filter("cookTimeUnion",function(){return function(e,r,n,t){if(!e)return e;r&&(e=[]),n&&(e=t?[{day:"2016-02-13",segment:[{name:"10",text:"10:00-20:00",status:!0}]},{day:"2016-02-14",segment:[{name:"10",text:"10:00-20:00",status:!0}]}]:[{day:"2016-02-14",segment:[{name:"10",text:"10:00-20:00",status:!0}]}]);var i=!!e[0].segment;return e.reduce(function(e,r){return i?r.segment.forEach(function(n){e.push({day:r.day,segment:n})}):e.push({day:r.day}),e},[])}}),angular.module("xw.filters").filter("dishes",function(){return function(e,r,n){var t;return"order"==r&&"displayCart"==n?(t=[],Object.keys(e).forEach(function(r){e[r].forEach(function(e){t.push({dish:e.dish._id,number:e.number,subDish:e.subDish.map(function(e){return{dish:e.dish._id,number:e.number}})})})}),{dishList:t}):e}}),angular.module("xw.filters").filter("coupon",function(){return function(e){var r={};return e.code&&(r.promotionCode=e.code,8==e.code.length&&(r.promotionCode="zz"+r.promotionCode)),e.card&&(r.coupon=e.card._id),r}}),angular.module("xw.filters").filter("eatTimeOptions",function(){return function(e){return e&&e.length?(e.unshift({hour:"请选择配送时间"}),e):e}}),angular.module("xw.filters").filter("eatTimeDisplay",function(){return function(e){return e.hour}}),angular.module("xw.filters").filter("cookTimeOptions",function(){return function(e){return e&&e.length?(e.unshift({day:"请选择配送时间"}),e):e}}),angular.module("xw.filters").filter("cookTimeDisplay",function(){return function(e){return"请选择配送时间"==e.day||e.segment?e.day:e.day+" 送达"}}),angular.module("xw.filters").filter("dishPrice",function(){return function(e,r){var n=e.dish.priceOriginal;if(e.subDish)for(var t=0,i=e.subDish.length;i>t;t++)n+=e.subDish[t].dish.priceOriginal;return n*(r?e.number:1)}}),angular.module("xw.filters").filter("orderStatus",function(){var e={"not paid":"未支付",paid:"已支付",confirmed:"已确认","dish finished":"已完成",packaged:"已打包",shipped:"配送中",finished:"已完成",canceled:"已取消"};return function(r){return e[r]||""}}),angular.module("xw.filters").filter("orderId",function(){return function(e){if(!e)return e;for(var r=[],n=0;n<e.length;n+=4)r.push(e.substr(n,4));return r.join(" ")}}),angular.module("xw.filters").filter("payment",function(){var e={"alipay direct":"支付宝",weixinpay:"微信钱包","account balance":"新味币"};return function(r){return e[r]||r}});
...
//# sourceMappingURL=app-dd995f8736.min.js.map
