...
angular.module("xw.directives").directive("addDishBar",["Debug","User","$localStorage","$filter","Utils",function(e,r,t,i,n){return{scope:{dish:"=",user:"=",localBag:"="},templateUrl:"add-dish-bar.html",link:function(e){var o=e.storage=t,u=e.localBag=[],c=e.$watch("user",function(r){r&&(c(),e.localBag=u=n.mergeCarts(u,r.shoppingCart),e.totalPrice())});e.$watch("dish",function(r){if(r){var t={};e.dish.preferences.forEach(function(e){e.foodMaterial.forEach(function(e){e.outOfStock=!(e.dish.stockWarehouseObj[o.warehouse]>0||"ready to cook"==e.dish.cookingType)}),e.foodMaterial.some(function(r){return r.outOfStock?!1:(t[e.name.zh]=r.dish,!0)})}),e.dish.curSelection=t}}),e.addToCart=function(t){var i,o=t.curSelection,c={dish:t,number:t.count,subDish:Object.keys(o).map(function(e){return{dish:o[e],number:t.count}})};u.some(function(e){return n.isSameItemInCart(e,c)?(i=e,i.number+=c.number,i.subDish.forEach(function(e){e.number=i.number}),!0):void 0}),i||u.push(c),t.count=0,e.hide(),r.postCart(u.filter(function(e){return!!e.dish}).map(a)),e.totalPrice()};var a=i("postDish");e.totalPrice=function(){var e=u.filter(function(e){return!!e.dish}).reduce(function r(e,t){return e+=t.dish.priceOriginal*t.number,t.subDish&&(e+=t.subDish.reduce(r,0)),e},0);return u.price=e},e.totalPrice(),e.hide=function(){e.dish=null}}}}]);
...
//# sourceMappingURL=app-8f1af47a93.min.js.map
