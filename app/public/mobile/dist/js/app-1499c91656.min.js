...
angular.module("xw.directives").directive("smsButton",["Debug","User","$interval",function(t,e,n){return{scope:{valid:"@",mobile:"@",type:"@"},templateUrl:"sms-button.html",link:function(a){function s(){return a.$watch("mobile",function(t){0===a.state&&t&&11==t.length?a.state=1:1!==a.state||t&&11==t.length?3===a.state&&t&&11==t.length?a.state=4:4!==a.state||t&&11==t.length||(a.state=3):a.state=0})}a.state=0,a.remains=60;var i=s();a.getSmsCode=function(){a.state=2,i&&(i(),i=null);var l=n(function(){--a.remains||(n.cancel(l),a.remains=60,t.assert("string"==typeof a.valid,"由@传入的valid应当是string"),"true"===a.valid?a.state=4:a.state=3,i=s())},1e3);e.getSmsCode({mobile:a.mobile,type:a.type}).then(function(t){t.data.code})["catch"](function(e){alert("获取验证码失败,请稍后重试"),t.alert(e)})}}}}]);
...
angular.module("xw.directives").directive("modal",function(){return{restrict:"E",transclude:!0,scope:{show:"=",close:"=",toggle:"="},templateUrl:"modal.html",link:function(o,e,s){function t(e,s){e.stopPropagation(),void 0===s?o.css.show=!o.css.show:o.css.show=s}o.css={show:!1},console.log(s["default"]),"show"==s["default"]&&(o.css.show=!0),o.show=function(){t(event,!0)},o.close=function(){t(event,!1)},o.toggle=function(){console.log("eatTime"),t(event)}}}});
...
//# sourceMappingURL=app-1499c91656.min.js.map
