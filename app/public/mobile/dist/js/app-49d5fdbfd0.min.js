...
angular.module("xw.directives").directive("couponCode",["Coupon","$q",function(e,o){return{restrict:"A",scope:{couponPrice:"=couponCode",couponCodeType:"="},require:"?ngModel",link:function(n,r,t,c){c&&(c.$asyncValidators.couponCode=function(r,t){var c=r||t;return c?(c=8==c.length?"zz"+c:c,e.getCouponInfo(c).then(function(e){var r=e.data,t=new Date(e.headers("date")),c=new Date(r.startDate),u=new Date(r.endDate);return t>=c&&u>=t?("promocodepercentage"==r.couponType&&(n.couponCodeType="promocodepercentage"),void(n.couponPrice=r.price)):o.reject("未在可使用期限内")})):o.resolve(1)})}}}]);
angular.module("xw.directives").directive("geetestSmsButton",["Debug","User","$interval","$window","Alert","$http",function(e,t,s,a,n,i){return{scope:{valid:"@",mobile:"@",type:"@",triggered:"="},templateUrl:"geetest-sms-button.html",link:function(e){function c(t,s){var a=e.state,n=!!s;"mobile"==t?0===a&&n?e.state=1:1!=a||n?2!=a||n?4==a&&n?e.state=5:5!=a||n||(e.state=4):e.state=4:e.state=0:"show-geetest"==t?(1==a||5==a)&&(e.state=2):"hide-geetest"==t?2==a&&(e.state=3):"show-refetch"==t&&3==a&&(e.state=n?5:4)}i.get("/api/user/signup/geetest/register").success(function(i){var r=document.createElement("script"),l={gt:"d41d16df5b99010ec511ec10aaaafcb8",width:document.body.offsetWidth,challenge:i.challenge};r.src="http://api.geetest.com/get.php?"+Object.keys(l).map(function(e){return e+"="+l[e]}).join("&");var u=angular.element(document.getElementById("geetestContainer"));u.append(r),a.gt_custom_ajax=function(a,i,r){if(a){var l=angular.element(document.getElementById("geetestContainer")).find("input"),u={geetest_challenge:l[0].value,geetest_validate:l[1].value,geetest_seccode:l[2].value,type:e.type,mobile:e.mobile},g=s(function(){if(!--e.remains){s.cancel(g),e.remains=o,e.triggered=!0,c("show-refetch","true"==e.valid);try{GeeTest[0].refresh()}catch(t){}}},1e3);t.getSmsCode(u).success(function(){console.log("success")})["catch"](function(e){n.show(e.data.validationStatus,"验证码发送失败")}),c("hide-geetest")}}});var o=30;e.remains=30,e.$watch("mobile",function(t){c("mobile","true"==e.valid)}),e.showGeetest=function(){c("show-geetest")},e.state=0}}}]);
...
angular.module("xw.directives").directive("flashClass",function(){return{restrict:"A",scope:{options:"=flashClass"},link:function(s,t){var o=s.options.duration||700,i=s.options.className||"flash";s.$watch("options.exp",function(s){s&&setTimeout(function(){t.addClass(i),setTimeout(function(){t.removeClass(i)},o)},200)})}}});
...
angular.module("xw.filters").filter("adapt",function(){var r=Math.floor(document.body.offsetWidth*window.devicePixelRatio),n=Math.floor(2*r/3),e="?imageView2/1/w/",t=e+r+"/h/"+n;return function(n,i){return n+(i?e+r+"/h/"+Math.floor(r*i):t)}}),angular.module("xw.filters").filter("fraction",function(){function r(r,n){for(var e="",t=0;t<r.length;t++)e+=n[r[t]];return e}var n=["⁰","¹","²","³","⁴","⁵","⁶","⁷","⁸","⁹"],e=["₀","₁","₂","₃","₄","₅","₆","₇","₈","₉"];return function(t){return t.replace(/(\d+)\/(\d+)/g,function(t,i,u){return r(i,n)+"⁄"+r(u,e)+" "})}}),angular.module("xw.filters").filter("postDish",function(){return function(r){return{dish:r.dish._id,number:r.number,subDish:r.subDish?r.subDish.map(function(r){return{dish:r.dish._id,number:r.number}}):[]}}}),angular.module("xw.filters").filter("beautifyMobile",function(){return function(r){return/^\d{11}$/.test(r)?r.replace(/^(\d{3})(\d{4})(\d{4})$/,function(r,n,e,t){return n+" "+e+" "+t}):r}}),angular.module("xw.filters").filter("subDishTitle",function(){return function(r){var n=r.subDish.length;return n?"("+r.subDish.reduce(function(r,e,t){return r+e.dish.title.zh+(t==n-1?"":"/")},"")+")":""}}),angular.module("xw.filters").filter("orderTime",function(){return function r(n,e){var t;return"eat"==e?{deliveryDateEat:n.hour.substr(0,10),deliveryTimeEat:n.hour.substr(11,5)}:"cook"==e?(t={deliveryDateCook:n.day},t.deliveryTimeCook=n.segment?n.segment.name+":00":"12:00",t):"all"==e?(t={},n.eat&&(t=r(n.eat,"eat")),n.cook&&angular.extend(t,r(n.cook,"cook")),t):void 0}}),angular.module("xw.filters").filter("cookTimeUnion",function(){return function(r){if(!r)return r;var n=!!r[0].segment;return r.reduce(function(r,e){return n?e.segment.forEach(function(n){r.push({day:e.day,segment:n})}):r.push({day:e.day}),r},[])}}),angular.module("xw.filters").filter("dishes",function(){return function(r,n,e){var t;return"order"==n&&"displayCart"==e?(t=[],Object.keys(r).forEach(function(n){r[n].forEach(function(r){t.push({dish:r.dish._id,number:r.number,subDish:r.subDish.map(function(r){return{dish:r.dish._id,number:r.number}})})})}),{dishList:t}):r}}),angular.module("xw.filters").filter("coupon",function(){return function(r){var n={};return r.code&&(n.promotionCode=r.code,8==r.code.length&&(n.promotionCode="zz"+n.promotionCode)),r.card&&(n.coupon=r.card._id),n}}),angular.module("xw.filters").filter("eatTimeOptions",function(){return function(r){return r&&r.length?(r.unshift({hour:"请选择配送时间"}),r):r}}),angular.module("xw.filters").filter("eatTimeDisplay",function(){return function(r){return r.hour}}),angular.module("xw.filters").filter("cookTimeOptions",function(){return function(r){return r&&r.length?(r.unshift({day:"请选择配送时间"}),r):r}}),angular.module("xw.filters").filter("cookTimeDisplay",function(){return function(r){return"请选择配送时间"==r.day||r.segment?r.day:r.day+" 送达"}}),angular.module("xw.filters").filter("dishPrice",function(){return function(r,n){var e=r.dish.priceOriginal;if(r.subDish)for(var t=0,i=r.subDish.length;i>t;t++)e+=r.subDish[t].dish.priceOriginal;return e*(n?r.number:1)}}),angular.module("xw.filters").filter("orderStatus",function(){var r={"not paid":"未支付",paid:"已支付",confirmed:"已确认","dish finished":"已完成",packaged:"已打包",shipped:"配送中",finished:"已完成",canceled:"已取消"};return function(n){return r[n]||""}}),angular.module("xw.filters").filter("orderId",function(){return function(r){if(!r)return r;for(var n=[],e=0;e<r.length;e+=4)n.push(r.substr(e,4));return n.join(" ")}}),angular.module("xw.filters").filter("payment",function(){var r={"alipay direct":"支付宝",weixinpay:"微信钱包","account balance":"新味币"};return function(n){return r[n]||n}});
...
//# sourceMappingURL=app-49d5fdbfd0.min.js.map
