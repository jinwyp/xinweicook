...
angular.module("xw.directives").directive("addDishBar",["Debug","User","$localStorage","$filter","Utils",function(e,r,t,i,o){return{scope:{dish:"=",user:"=",localBag:"="},templateUrl:"add-dish-bar.html",link:function(e){var n=e.storage=t,u=e.localBag=[],a=e.$watch("user",function(r){r&&(a(),e.localBag=u=o.mergeCarts(u,r.shoppingCart),e.totalPrice())});e.$watch("dish",function(r){if(r){var t={};e.dish.preferences.forEach(function(e){e.foodMaterial.forEach(function(e){e.outOfStock=!(e.dish.stockWarehouseObj[n.warehouse]>0||"ready to cook"==e.dish.cookingType)}),e.foodMaterial.some(function(r){return r.outOfStock?!1:(t[e.name.zh]=r.dish,!0)})}),e.dish.curSelection=t}}),e.addToCart=function(t){var i,n=t.curSelection,a={dish:t,number:t.count,subDish:Object.keys(n).map(function(e){return{dish:n[e],number:t.count}})};u.some(function(e){return o.isSameItemInCart(e,a)?(i=e,i.number+=a.number,i.subDish.forEach(function(e){e.number=i.number}),!0):void 0}),i||u.push(a),t.count=0,e.hide(),r.postCart(u.map(c)),e.totalPrice()};var c=i("postDish");e.totalPrice=function(){var e=u.reduce(function r(e,t){return e+=t.dish.priceOriginal*t.number,t.subDish&&(e+=t.subDish.reduce(r,0)),e},0);return u.price=e},e.totalPrice(),e.hide=function(){e.dish=null}}}}]);
...
//# sourceMappingURL=app-077a20ad1d.min.js.map
