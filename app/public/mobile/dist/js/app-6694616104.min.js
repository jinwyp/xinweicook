...
angular.module("xw.directives").directive("address",["$timeout","$location","Address","Utils","$q","Weixin","Map",function(e,t,r,d,s,n,i){return{restrict:"E",scope:{outAddress:"=",range:"=",save:"=",leave:"=",valid:"=",deleteHook:"&",hide:"&",cur:"@"},templateUrl:"address.html",link:function(e){var o,a=e.css={edit:!1,cur:"true"==e.cur,showSearchAddress:!1,form:null,locating:!1,isWeixin:n.isWeixin,isNewAddress:Object.keys(e.outAddress).length<2},u=e.data={street:""};a.isNewAddress?(o=e.addr={sortOrder:0},a.cur&&(a.edit=!0)):o=e.addr=d.regularizeAddress(angular.copy(e.outAddress),e.range),e.outAddress.cur=a.cur,e.outAddress.edit=!!a.edit,e.options=d.addressOptions.bind(null,e.range),e.$on("$locationChangeStart",function(){if(a.edit){var e=t.path();a.showSearchAddress="/search-address"==e}}),e.choose=function(){a.cur?(a.edit=!0,e.outAddress.edit=!0):(a.cur=!0,a.isNewAddress&&(a.edit=!0,e.outAddress.edit=!0)),e.outAddress.cur=!0},e.trySelectUnique=function(){var t=e.options(o.province);1==t.length&&(o.city=t[0])},e.deleteAddress=function(t){t.stopPropagation(),r["delete"](o._id),e.deleteHook&&e.deleteHook()},e.showSearchAddress=function(){u.street=o.street,t.path("search-address"),e.data.streetList&&(e.data.streetList.length=0),e.searchAddress()},e.searchAddress=function(){u.street&&i.search(u.street,o.city||"全国").then(function(t){e.data.streetList=t.data.results})},e.confirmStreet=function(e,r){e.stopPropagation(),t.path(""),r&&(o.street=r.name,o.geoLatitude=r.location.lat,o.geoLongitude=r.location.lng)},e.save=function(){return a.form.$invalid?s.resolve(!1):(a.edit=a.cur=!1,e.outAddress.edit=e.outAddress.cur=!1,o.isDefault=!0,r[a.isNewAddress?"addOne":"update"](o).then(function(t){return o=e.addr=t.data,angular.extend(e.outAddress,t.data),t.data}))},e.leave=function(){e.outAddress.cur=a.cur=!1},e.valid=function(){return a.form.$submitted=!0,!a.form.$invalid},e.initForm=function(e){a.form=e,a.showFakeInput=!o.province},e.locate=function(t){t.stopPropagation(),a.locating=!0,n.getLocation(function(t){n.getLocationName(t.latitude,t.longitude).then(function(r){var s=r.data.result;s=angular.pick(s.addressComponent,"province","city","district","street","street_number");var n=i.gcj02ToBd09({lat:t.latitude,lng:t.longitude});s.geoLatitude=n.lat,s.geoLongitude=n.lng,d.regularizeAddress(s,e.range),angular.extend(o,s)})["catch"](angular.noop).then(function(){a.locating=!1})},function(){a.locating=!1})}}}}]);
angular.module("xw.directives").directive("addressList",["$q",function(e){return{restrict:"E",scope:{addresses:"=",range:"=",watchAddress:"=save",editing:"=",hideOthersWhenEdit:"@"},templateUrl:"address-list.html",link:function(s){var d=s.data={newAddress:{}},r=s.handler={save:[],leave:[],valid:[]};s.hideAddress=function(e){if("true"==s.hideOthersWhenEdit&&s.addresses){var d=-1;return s.data.newAddress.edit&&(d=-2),-1==d&&s.addresses.some(function(e,s){return e.edit?(d=s,!0):void 0}),-1!=d&&e!=d}},s.editing=function(){return s.addresses?!!d.newAddress.edit||s.addresses.some(function(e){return e.edit}):!1},s.remove=function(e){s.addresses.splice(e,1),r.save.splice(e,1),r.leave.splice(e,1),r.valid.splice(e,1)},s.watchAddress=function(t){var n,i=t.target,a=i;do if(-1!=a.className.indexOf("address-item"))for(var l=a.parentElement.children,c=0,o=l.length;o>c;c++)if(l[c]==a){n=c;break}while(a=a.parentElement);var u=-1,v=-1;if(s.addresses.forEach(function(e,s){e.edit&&(u=s),e.cur&&(v=s)}),!(n==v||n==s.addresses.length&&d.newAddress.cur)){var f;if(-1!=u){if(!r.valid[u]())return t.stopPropagation();f=r.save[u]()}else if(d.newAddress.edit){if(!r.valid.newAddress())return t.stopPropagation();f=r.save.newAddress().then(function(e){return s.addresses.push(e),d.newAddress={},e})}return-1!=v?(r.leave[v](),-1==u&&(f=e.resolve(s.addresses[v]))):d.newAddress.cur&&r.leave.newAddress(),f}}}}}]);
...
//# sourceMappingURL=app-6694616104.min.js.map
