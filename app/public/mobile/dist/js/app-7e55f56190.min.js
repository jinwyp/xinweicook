...
angular.module("xw.directives").directive("addDishBar",["Debug","User","$localStorage","$filter","Utils",function(r,t,e,c,i){return{scope:{dish:"=",user:"=",cart:"="},templateUrl:"add-dish-bar.html",link:function(r){var n=r.$watch("user",function(t){t&&(n(),r.cart=i.mergeCarts(e.localBag||[],t.shoppingCart),r.totalPrice())});r.$watch("dish",function(t){if(t){var e={};r.dish.preferences.forEach(function(r){r.foodMaterial.some(function(t){return t.dish.outOfStock?!1:(e[r.name.zh]=t.dish,!0)})}),r.dish.curSelection=e}}),e.localBag&&(r.cart=e.localBag),r.addToCart=function(c){var n,u=c.curSelection,o={dish:c,number:c.count,subDish:Object.keys(u).map(function(r){return{dish:u[r],number:c.count}})};r.cart.some(function(r){return i.isSameItemInCart(r,o)?(n=r,n.number+=o.number,n.subDish.forEach(function(r){r.number=n.number}),!0):void 0}),n||r.cart.push(o),c.count=0,r.hide(),t.postCart(r.cart.map(a))["catch"](function(){e.localBag=r.cart}),r.totalPrice()};var a=c("postDish");r.totalPrice=function(){var t=r.cart.reduce(function e(r,t){return r+=t.dish.priceOriginal*t.number,t.subDish&&(r+=t.subDish.reduce(e,0)),r},0);return r.cart.price=t},r.totalPrice(),r.hide=function(){r.dish=null}}}}]);
