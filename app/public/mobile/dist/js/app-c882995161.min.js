...
angular.module("xw.directives").directive("addDishBar",["Debug","User","$localStorage","$filter","Utils",function(e,r,t,i,n){return{scope:{dish:"=",user:"=",localBag:"="},templateUrl:"add-dish-bar.html",link:function(e){var u=(e.storage=t,e.localBag=[]),o=e.$watch("user",function(r){r&&(o(),e.localBag=u=n.mergeCarts(u,r.shoppingCart),e.totalPrice())});e.$watch("dish",function(r){if(r){var t={};e.dish.preferences.forEach(function(e){e.foodMaterial.some(function(r){return r.dish.outOfStock?!1:(t[e.name.zh]=r.dish,!0)})}),e.dish.curSelection=t}}),e.addToCart=function(t){var i,o=t.curSelection,c={dish:t,number:t.count,subDish:Object.keys(o).map(function(e){return{dish:o[e],number:t.count}})};u.some(function(e){return n.isSameItemInCart(e,c)?(i=e,i.number+=c.number,i.subDish.forEach(function(e){e.number=i.number}),!0):void 0}),i||u.push(c),t.count=0,e.hide(),r.postCart(u.map(a)),e.totalPrice()};var a=i("postDish");e.totalPrice=function(){var e=u.reduce(function r(e,t){return e+=t.dish.priceOriginal*t.number,t.subDish&&(e+=t.subDish.reduce(r,0)),e},0);return u.price=e},e.totalPrice(),e.hide=function(){e.dish=null}}}}]);
...
angular.module("xw.directives").directive("modal",function(){return{restrict:"E",transclude:!0,scope:{show:"=",close:"=",toggle:"=",preClose:"=?"},templateUrl:"modal.html",link:function(e,o,s){function t(o,s){o.stopPropagation(),e.css.show=void 0===s?!e.css.show:s}e.css={show:!1},"show"==s["default"]&&(e.css.show=!0),e.show=function(){t(event,!0)},e.close=function(o){!o&&e.preClose&&e.preClose(),t(event,!1)},e.toggle=function(){t(event)}}}});
...
angular.module("xw.directives").directive("address",["$timeout","$location","Address","Utils","$q","Weixin","Map",function(e,t,r,d,s,n,o){return{restrict:"E",scope:{outAddress:"=",range:"=",save:"=",leave:"=",valid:"=",deleteHook:"&",cur:"@"},templateUrl:"address.html",link:function(e){var a,i=e.css={edit:!1,cur:"true"==e.cur,showSearchAddress:!1,form:null,locating:!1,isWeixin:n.isWeixin,isNewAddress:Object.keys(e.outAddress).length<2},u=e.data={street:""};i.isNewAddress?(a=e.addr={sortOrder:0},i.cur&&(i.edit=!0)):a=e.addr=d.regularizeAddress(angular.copy(e.outAddress),e.range),e.outAddress.cur=i.cur,e.outAddress.edit=!!i.edit,e.options=d.addressOptions.bind(null,e.range),e.$on("$locationChangeStart",function(){if(i.edit){var e=t.path();i.showSearchAddress="/search-address"==e}}),e.choose=function(){i.cur?(i.edit=!0,e.outAddress.edit=!0):(i.cur=!0,i.isNewAddress&&(i.edit=!0,e.outAddress.edit=!0)),e.outAddress.cur=!0},e.trySelectUnique=function(){var t=e.options(a.province);1==t.length&&(a.city=t[0])},e.deleteAddress=function(t){t.stopPropagation(),r["delete"](a._id),e.deleteHook&&e.deleteHook()},e.showSearchAddress=function(){u.street=a.street,t.path("search-address"),e.data.streetList&&(e.data.streetList.length=0),e.searchAddress()},e.searchAddress=function(){u.street&&o.search(u.street,a.city||"全国").then(function(t){e.data.streetList=t.data.results})},e.confirmStreet=function(e,r){e.stopPropagation(),t.path(""),r&&(a.street=r.name,a.geoLatitude=r.location.lat,a.geoLongitude=r.location.lng)},e.save=function(){return i.form.$invalid?s.resolve(!1):(i.edit=i.cur=!1,e.outAddress.edit=e.outAddress.cur=!1,r[i.isNewAddress?"addOne":"update"](a).then(function(t){return a=e.addr=t.data,angular.extend(e.outAddress,t.data),t.data}))},e.leave=function(){e.outAddress.cur=i.cur=!1},e.valid=function(){return i.form.$submitted=!0,!i.form.$invalid},e.initForm=function(e){i.form=e,i.showFakeInput=!a.province},e.locate=function(t){t.stopPropagation(),i.locating=!0,n.getLocation(function(t){n.getLocationName(t.latitude,t.longitude).then(function(r){var s=r.data.result;s=angular.pick(s.addressComponent,"province","city","district","street","street_number");var n=o.gcj02ToBd09({lat:t.latitude,lng:t.longitude});s.geoLatitude=n.lat,s.geoLongitude=n.lng,d.regularizeAddress(s,e.range),angular.extend(a,s)})["catch"](angular.noop).then(function(){i.locating=!1})},function(){i.locating=!1})}}}}]);
angular.module("xw.directives").directive("addressList",["$q",function(e){return{restrict:"E",scope:{addresses:"=",range:"=",watchAddress:"=save",editing:"="},templateUrl:"address-list.html",link:function(s){var r=s.data={newAddress:{}},d=s.handler={save:[],leave:[],valid:[]};s.editing=function(){return s.addresses?!!r.newAddress.edit||s.addresses.some(function(e){return e.edit}):!1},s.remove=function(e){s.addresses.splice(e,1),d.save.splice(e,1),d.leave.splice(e,1),d.valid.splice(e,1)},s.watchAddress=function(a){var n,t=a.target,i=t;do if(-1!=i.className.indexOf("address-item"))for(var l=i.parentElement.children,c=0,o=l.length;o>c;c++)if(l[c]==i){n=c;break}while(i=i.parentElement);var v=-1,u=-1;if(s.addresses.forEach(function(e,s){e.edit&&(v=s),e.cur&&(u=s)}),!(n==u||n==s.addresses.length&&r.newAddress.cur)){var f;if(-1!=v){if(!d.valid[v]())return a.stopPropagation();f=d.save[v]()}else if(r.newAddress.edit){if(!d.valid.newAddress())return a.stopPropagation();f=d.save.newAddress().then(function(e){return s.addresses.push(e),r.newAddress={},e})}return-1!=u?(d.leave[u](),-1==v&&(f=e.resolve(s.addresses[u]))):r.newAddress.cur&&d.leave.newAddress(),f}}}}}]);
...
angular.module("xw.directives").directive("menuNav",function(){return{restrict:"E",scope:{path:"@",localBag:"=",tryBuy:"&",isValid:"&"},templateUrl:"menu-nav.html",link:function(t){t.goToCart=function(){return t.localBag&&t.localBag.length?void(location.href="/mobile/cart"):void alert("请至少添加一份菜品")}}}});
...
angular.module("xw.config").constant("errCode",function(){return{user:{wrongMobile:1110,wrongPassword:1111,alreadyExist:1112,notFound:1113,addressIdWrong:1210,addressNotFound:1212,addressLatitudeWrong:1220,addressLongitudeWrong:1221,addressCoordTypeWrong:1222,addressProvinceWrong:1225,addressCityWrong:1226,addressDistrictWrong:1227,addressStreetWrong:1228,addressStreetNumberWrong:1229,addressAddressWrong:1230,addressContactPersonWrong:1235,addressMobileWrong:1236,addressSortOrderWrong:1237,addressNotDeliver:1270,addressBaiduMapNotFoundError:1280},order:{notFound:2010,orderIdWrong:2011,warehouseIdWrong:2012,cookingTypeWrong:2110,clientFromWrong:2112,creditWrong:2115,freightWrong:2117,paymentWrong:2119,paymentUsedCashWrong:2120,deliveryDateCookWrong:2122,deliveryTimeCookWrong:2124,deliveryDateEatWrong:2126,deliveryTimeEatWrong:2128,dishListArrayWrong:2130,dishListDishNumberWrong:2132,dishListDishIdWrong:2134,dishListSubDishArrayWrong:2136,dishListSubDishNumberWrong:2138,dishListSubDishIdWrong:2139,addressLatitudeWrong:2140,addressLongitudeWrong:2142,addressProvinceWrong:2144,addressCityWrong:2145,addressDistrictWrong:2146,addressStreetWrong:2147,addressStreetNumberWrong:2148,addressAddressWrong:2149,addressContactPersonWrong:2152,addressMobileWrong:2154,addressIdWrong:2160,userCommentWrong:2180,dishIdInvalid:2190,notOnlyDrink:2192,notOverTenDrinks:2194},sms:{wrongCode:3110,expired:3111,invalidCode:3112,wrongType:3113,tooManyTries:3114,sendFailed:3115,reachSendLimitation:3116},dish:{outOfStock:4110},coupon:{notStart:5110,expired:5111,used:5112,outOfCount:5113,notFound:5120,couponIdWrong:5210,promotionCodeWrong:5212},announcement:{announcementIdWrong:8110,notFound:8112}}}),angular.module("xw.config").factory("commonInterceptor",["$localStorage","$q",function(e,o){var r=[/^\/mobile\/$/,/^\/mobile\/login/,/^\/mobile\/cook/,/^\/mobile\/cart/,/^\/mobile\/resetpwd$/],n=["/api/user","/api/user/token","/api/user/shoppingcart","/api/user/address"],s=["/mobile/me","/mobile/addresslist","/mobile/orderaddress","/mobile/orderlist","/mobile/invite","/mobile/coupons","/mobile/cook","/mobile/balance","/mobile/chargebalanceonline"];return{request:function(o){return e.access_token&&(o.headers.Authorization="Bearer "+e.access_token),o},responseError:function(e){var t="";if(401==e.status){if(console.log(401),r.some(function(e){return e.test(location.pathname)})&&-1!=n.indexOf(e.config.url))return o.reject(e);s.some(function(e){return-1!=location.pathname.indexOf(e)})&&(t="?redirect="+location.pathname),setTimeout(function(){location.replace("/mobile/login"+t)},120)}return o.reject(e)}}}]),angular.module("xw.config").config(["$httpProvider","$compileProvider",function(e,o){e.defaults.headers.common.Accept="application/vnd.cook.v1+json",e.defaults.headers.common["Access-Control-Allow-Origin"]="http://m.xinweicook.com",e.defaults.headers.common["Accept-Language"]="zh-CN"==navigator.language?"zh-CN":"en-US",e.defaults.headers.common["Content-Type"]="application/json",e.interceptors.push("commonInterceptor"),o.debugInfoEnabled(!1)}]),angular.pick=function(e){var o=Array.prototype.slice.call(arguments,1);return o.reduce(function(o,r){return o[r]=e[r],o},{})},angular.sort=function(e,o){for(var r,n=e.slice(0),s=n.length-1;s>=1;s--)for(var t=0;s>t;t++){var d=o(n[t],n[t+1]);d>0&&(r=n[t],n[t]=n[t+1],n[t+1]=r)}return n};
//# sourceMappingURL=app-c882995161.min.js.map
