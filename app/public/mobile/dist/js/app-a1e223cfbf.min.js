...
angular.module("xw.services").provider("Debug",["Utils",function(e){var t=this;t.debugKey="debug",this.$get=function(){var r=new RegExp("\\b"+t.debugKey+"\\b"),s="",o=e.searches(location.search);r=r.test(location.search)||!!sessionStorage.getItem("debug"),r&&!sessionStorage.getItem("debug")&&sessionStorage.setItem("debug","true"),r&&"fakewarehouse"in o&&(s=o.fakewarehouse);var a={isDebug:r,alert:function(e){this.isDebug&&(console.log(e),e="[object Object]"==Object.prototype.toString.call(e)?JSON.stringify(e):e,alert(e))},assert:function(e,t){this.isDebug&&!e&&alert(t)},promiseErrFn:function(e){return function(t){a.alert(e),a.alert(t)}},fakeWarehouse:s};return a}}]);
angular.module("xw.services").factory("Map",["$http","Debug",function(e,n){var a={xinweioffice:6e3,caohejing1:1560},t={bentoNoReach:999999,topDistance:{xinweioffice:6e3,caohejing1:1560},suggestion:function(n,a){return e.get("/mobile/placesuggestion?query="+n+"&region="+a)},gcj02ToBd09:function(e){var n=e.lat,a=e.lng,t=Math.sqrt(a*a+n*n)+2e-5*Math.sin(n*Math.PI),i=Math.atan2(n,a)-3e-6*Math.cos(a*Math.PI);return{lng:t*Math.cos(i)+.0065,lat:t*Math.sin(i)+.006}},bd09ToGcj02:function(e){var n=e.lat-.006,a=e.lng-.0065,t=Math.sqrt(a*a+n*n)-2e-5*Math.sin(n*Math.PI),i=Math.atan2(n,a)-3e-6*Math.cos(a*Math.PI);return{lng:t*Math.cos(i),lat:t*Math.sin(i)}},lineDistance:function(e,n,a,t){var i=6371e3,r=Math.cos(e*Math.PI/180)*Math.cos(a*Math.PI/180)*Math.cos((n-t)*Math.PI/180),o=Math.sin(e*Math.PI/180)*Math.sin(a*Math.PI/180),s=r+o;s>1&&(s=1),-1>s&&(s=-1);var c=Math.acos(s);return c*i},lineDistance2CHJ:function(e,n){var a=this.warehouseCoords.caohejing1;return this.lineDistance(e,n,a.lat,a.lng)},fixZero:function(e,n,a){if(0!==e)return e;var t=this.lineDistance(n,a,31.189426,121.460625);return t>1500?999999:e},walkingDistance:function(n,t,i){var r;i=i||"",Array.isArray(arguments[0])?(r=arguments[0],i=t):r=[{lat:n,lng:t}];var o="";return r.forEach(function(e,n){if(!(n>=5)){var a=0==n?"":"|";o+="string"==typeof e?a+e:a+e.lat+","+e.lng}}),e.get("/mobile/distance?destinations="+encodeURIComponent(o)+"&warehouse="+i).then(function(e){for(var n,t=e.data.result.elements,i=[],r=t.length/2,o=0;r>o;o++)t[o].warehouse="xinweioffice",t[r+o].warehouse="caohejing1",n=[t[o],t[r+o]],n=angular.sort(n,function(e,n){return e.distance.value-a.xinweioffice-(n.distance.value-a.caohejing1)}),i.push(n);return i})["catch"](function(){return console.log("get distance error"),[]})},distance:function(e,i,r){return this.walkingDistance(e,i,r).then(function(n){var r=n[0][0].distance.value;r=t.fixZero(r,e,i);var o=a[n[0][0].warehouse];return{distance:r,isInRange:o>=(null===r?999999:r),warehouse:n[0][0].warehouse}})["catch"](function(e){n.alert("获取步行距离失败"),n.alert(e)})},distances:function(e,n){return e=Array.isArray(e)?e:[e],this.walkingDistance(e,n).then(function(n){return n.map(function(n,i){var r=t.fixZero(n[0].distance.value,e[i].lat,e[i].lng),o=a[n[0].warehouse];return{distance:r,isInRange:o>=(null===r?999999:r),warehouse:n[0].warehouse}})})},nearestWarehouse:function(e,t){var i=this,r=a.xinweioffice,o=a.caohejing1,s=angular.sort(["xinweioffice","caohejing1"].map(function(n){var a=i.warehouseCoords[n];return{name:n,distance:i.lineDistance(e,t,a.lat,a.lng)}}),function(e,n){return e.distance-r+1100-(n.distance-o)});return n.fakeWarehouse?n.fakeWarehouse:s[0].name},warehouseCoords:{xinweioffice:{lat:31.189426,lng:121.460625},caohejing1:{lat:31.16925,lng:121.398949}}};return t}]);
...
angular.module("xw.config").constant("errCode",function(){return{user:{wrongMobile:1110,wrongPassword:1111,alreadyExist:1112,notFound:1113,addressIdWrong:1210,addressNotFound:1212,addressLatitudeWrong:1220,addressLongitudeWrong:1221,addressCoordTypeWrong:1222,addressProvinceWrong:1225,addressCityWrong:1226,addressDistrictWrong:1227,addressStreetWrong:1228,addressStreetNumberWrong:1229,addressAddressWrong:1230,addressContactPersonWrong:1235,addressMobileWrong:1236,addressSortOrderWrong:1237},order:{notFound:2010,orderIdWrong:2011,warehouseIdWrong:2012,cookingTypeWrong:2110,clientFromWrong:2112,creditWrong:2115,freightWrong:2117,paymentWrong:2119,paymentUsedCashWrong:2120,deliveryDateCookWrong:2122,deliveryTimeCookWrong:2124,deliveryDateEatWrong:2126,deliveryTimeEatWrong:2128,dishListArrayWrong:2130,dishListDishNumberWrong:2132,dishListDishIdWrong:2134,dishListSubDishArrayWrong:2136,dishListSubDishNumberWrong:2138,dishListSubDishIdWrong:2139,addressLatitudeWrong:2140,addressLongitudeWrong:2142,addressProvinceWrong:2144,addressCityWrong:2145,addressDistrictWrong:2146,addressStreetWrong:2147,addressStreetNumberWrong:2148,addressAddressWrong:2149,addressContactPersonWrong:2152,addressMobileWrong:2154,addressIdWrong:2160,userCommentWrong:2180,dishIdInvalid:2190,notOnlyDrink:2192,notOverTenDrinks:2194},sms:{wrongCode:3110,expired:3111,invalidCode:3112,wrongType:3113,tooManyTries:3114,sendFailed:3115,reachSendLimitation:3116},dish:{outOfStock:4110},coupon:{notStart:5110,expired:5111,used:5112,outOfCount:5113,notFound:5120,couponIdWrong:5210,promotionCodeWrong:5212},announcement:{announcementIdWrong:8110,notFound:8112}}}),angular.module("xw.config").factory("commonInterceptor",["$localStorage","$q",function(o,e){var r=[/^\/mobile\/$/,/^\/mobile\/login/,/^\/mobile\/cook/,/^\/mobile\/cart/,/^\/mobile\/resetpwd$/],n=["/api/user","/api/user/token","/api/user/shoppingcart"],t=["/mobile/me","/mobile/addresslist","/mobile/orderaddress","/mobile/orderlist","/mobile/invite","/mobile/coupons","/mobile/cook","/mobile/balance","/mobile/chargebalanceonline"];return{request:function(e){return o.access_token&&(e.headers.Authorization="Bearer "+o.access_token),e},responseError:function(o){var s="";if(401==o.status){if(console.log(401),r.some(function(o){return o.test(location.pathname)})&&-1!=n.indexOf(o.config.url))return e.reject(o);t.some(function(o){return-1!=location.pathname.indexOf(o)})&&(s="?redirect="+location.pathname),setTimeout(function(){location.replace("/mobile/login"+s)},120)}return e.reject(o)}}}]),angular.module("xw.config").config(["$httpProvider","$compileProvider",function(o,e){o.defaults.headers.common.Accept="application/vnd.cook.v1+json",o.defaults.headers.common["Access-Control-Allow-Origin"]="http://m.xinweicook.com",o.defaults.headers.common["Accept-Language"]="zh-CN"==navigator.language?"zh-CN":"en-US",o.defaults.headers.common["Content-Type"]="application/json",o.interceptors.push("commonInterceptor"),e.debugInfoEnabled(!1)}]),angular.pick=function(o){var e=Array.prototype.slice.call(arguments,1);return e.reduce(function(e,r){return e[r]=o[r],e},{})},angular.sort=function(o,e){for(var r,n=o.slice(0),t=n.length-1;t>=1;t--)for(var s=0;t>s;s++){var d=e(n[s],n[s+1]);d>0&&(r=n[s],n[s]=n[s+1],n[s+1]=r)}return n};
//# sourceMappingURL=app-a1e223cfbf.min.js.map
